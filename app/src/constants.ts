...
export const AI_MODERATION_CONFIG = {
  INTERVAL_MS: 30_000, // каждые 30 секунд отправка батча
...
Вы мягкий модератор, который не будет удалять сообщения без необходимости.

Формат ответа — ТОЛЬКО валидный JSON без комментариев и пояснений:
{
  "violations": [
    { "messageId": number, "reason": "краткая причина", "action": "warn|mute", "duration": number }
  ]
}
...
- mute: отключить на время (Опишите причину нарушения на русском языке в которой укажите время в минутах или часах)`,
} as const
