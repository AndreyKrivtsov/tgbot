...
export function makeEventBus(): EventBus {
  ...
  return ({
    ...
    onGroupAgentModerationAction: jest.fn(),
    emitGroupAgentModerationAction: emitFunc,
    onGroupAgentResponse: jest.fn(),
    emitGroupAgentResponse: emitFunc,
    onGroupAgentTypingStarted: jest.fn(),
    emitGroupAgentTypingStarted: emitFunc,
    onGroupAgentTypingStopped: jest.fn(),
    emitGroupAgentTypingStopped: emitFunc,
    onGroupAgentReviewPrompt: jest.fn(),
    emitGroupAgentReviewPrompt: emitFunc,
    onGroupAgentReviewPromptSent: jest.fn(),
    emitGroupAgentReviewPromptSent: emitFunc,
    onGroupAgentReviewDecision: jest.fn(),
    emitGroupAgentReviewDecision: emitFunc,
    onGroupAgentReviewResolved: jest.fn(),
    emitGroupAgentReviewResolved: emitFunc,
    onGroupAgentReviewDeletePrompt: jest.fn(),
    emitGroupAgentReviewDeletePrompt: emitFunc,
    onGroupAgentReviewDisablePrompt: jest.fn(),
    emitGroupAgentReviewDisablePrompt: emitFunc,
